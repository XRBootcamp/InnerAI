...
namespace PassthroughCameraSamples.CameraToWorld
{
    ...
    public class CameraToWorldManager2 : MonoBehaviour
    {
        ...
        public void ToggleCameraMarkers()
        {
            m_headMarker.SetActive(!m_headMarker.activeSelf);
            m_cameraMarker.SetActive(!m_cameraMarker.activeSelf);
            m_rayGo1.SetActive(!m_rayGo1.activeSelf);
            m_rayGo2.SetActive(!m_rayGo2.activeSelf);
